...
const Challenges = () => {
  return (
    <div className="min-h-screen max-h-fit bg-white">
      <Navbar />
      <div className="pt-[160px] flex flex-col">
        <div className="font-[700] pb-[50px] mx-auto text-[40px] DMSerif">
          Common challenges front-end web developers face include:
        </div>

        <div className="max-w-[1264px] mx-auto grid grid-cols-2 gap-16 justify-evenly">
        ...
        <div className="text-[20px] font-[400] h-[386px] bg-[#FAEBD7]">
          <div className="w-1/2 text-center m-auto mt-16">
        ...
        <div className="text-[20px] w-1/2 text-center m-auto mt-16">
          ...
          <div className="text-[16px] text-left w-1/2 m-auto mt-16">
Pick something that makes you excited to code and get on with building it. Use
...
practices by contributing to Project Source. <br/> <br/>
...
small & large-scale projects.
        ...
        <div className="mt-[100px] bg-black h-[150px]">
